  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold tracking-tight">{isEdit ? "Edit Ticket" : "New Ticket"}</h1>
      </div>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g. AC leaking in Room 302" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g. Blocked drainage pipe" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button type="submit">
              <Save className="mr-2 h-4 w-4" /> {isEdit ? "Update Ticket" : "Create Ticket"}
            </Button>
          </div>
        </form>
      </Form>
